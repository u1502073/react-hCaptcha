...
const Hcaptcha = ({
  ...
  const [elementId, setElementId] = useState(`hcaptcha-${randomID()}`);
  ...
  },[ handleSubmit, removeCaptcha, renderCaptcha, dataSiteKey, disabled, isRemoved, size, theme, tabindex, languageOverride, endpoint])
  ...
  const renderCaptcha = useCallback((handleSubmit) => {
